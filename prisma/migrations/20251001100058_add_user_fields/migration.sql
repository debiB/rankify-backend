...
ALTER TABLE `KeywordCannibalizationResult`
DROP
FOREIGN KEY `KeywordCannibalizationResult_auditId_fkey`;
...
CREATE TABLE `AdminNotificationPreferencesGlobal` ( `id` VARCHAR(191) NOT NULL,
...
CREATE TABLE `user_settings` ( `id` VARCHAR(191) NOT NULL,
                                                 `userId` VARCHAR(191) NOT NULL,
...
ALTER TABLE `AdminNotificationPreferencesGlobal` ADD CONSTRAINT `AdminNotificationPreferencesGlobal_userId_fkey`
